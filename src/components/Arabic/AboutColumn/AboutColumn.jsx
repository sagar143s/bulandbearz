...
const columnsData = [
    {
      ...
      caption: 'المهمة',
      content: 'تمكين العملاء لتجاوز الأهداف من خلال عمليات مصقولة وخطط استراتيجية وتطوير فردي لتحقيق أداء متميز.',
    },
    {
      imageSrc: 'https://web.moxcreative.com/ventuure/wp-content/uploads/sites/20/2023/03/consulting-each-other-on-a-project.jpg',
      caption: 'الرؤية',
      content: 'ريادة التغيير المحوري من أجل نجاح العملاء. نرتقي بمعايير المشاريع، موجهين العملاء نحو مستويات جديدة من التفوق بدقة التخطيط. ',
    },
    {
      imageSrc: 'https://web.moxcreative.com/ventuure/wp-content/uploads/sites/20/2023/03/top-view-of-business-women-comparing-financial-graphs-with-management-statistics-expertise.jpg',
      caption: 'القيمة',
      content: 'إطلاق التميّز. التزامنا هو تقديم خدمة متفوقة، وتحسين معايير المشروع، وتوجيه العملاء نحو النجاح المستدام.',
    },
  ];
const AboutColumn = () => {
  return (
    <Container style={{marginTop:'3rem'}}>
        <Typography fontSize='30px' fontWeight='600' color='#f3904f' align='center'>الخبرة</Typography>
